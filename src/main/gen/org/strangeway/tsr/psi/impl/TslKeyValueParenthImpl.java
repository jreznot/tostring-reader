...
public class TslKeyValueParenthImpl extends ASTWrapperPsiElement implements TslKeyValueParenth {

  public TslKeyValueParenthImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TslVisitor visitor) {
    visitor.visitKeyValueParenth(this);
  }
